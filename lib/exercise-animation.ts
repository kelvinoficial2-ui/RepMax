...
const animations: Record<string, ExerciseAnimation> = {
  ...
  'supino-declinado-maquina-articulada': {
    src: 'https://res.cloudinary.com/doo0fzoef/image/upload/v1788664206/avatares/Decline_Chest_Press_Machine_Overview___Form_Tips_Benefits_1.gif',
    animatedGif: true,
    cellSize: 1,
    columns: 1,
    upwardPoses: [0],
  ...
  'triceps-polia': {
    src: 'https://res.cloudinary.com/doo0fzoef/image/upload/v1788663728/avatares/Tr%C3%ADceps_Pulley.gif',
    animatedGif: true,
    cellSize: 1,
    columns: 1,
    upwardPoses: [0],
  ...
  'triceps-frances-unilateral-sentado-halter': {
    src: 'https://res.cloudinary.com/doo0fzoef/image/upload/v1788663615/avatares/download_8.gif',
    animatedGif: true,
    cellSize: 1,
    columns: 1,
    upwardPoses: [0],
  ...
  'triceps-testa-declinado-halteres': {
    src: 'https://res.cloudinary.com/doo0fzoef/image/upload/v1788663655/avatares/download_9.gif',
    animatedGif: true,
    cellSize: 1,
    columns: 1,
    upwardPoses: [0],
